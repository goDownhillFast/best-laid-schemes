...
class WindowsControllerTest < ActionController::TestCase
  ...
  test "should create window" do
    assert_difference('Window.count') do
      post :create, window: { activity_id: @window.activity_id, begin_time: @window.begin_time, end_time: @window.end_time }
    end
  ...
  test "should update window" do
    put :update, id: @window, window: { activity_id: @window.activity_id, begin_time: @window.begin_time, end_time: @window.end_time }
    assert_redirected_to window_path(assigns(:window))
  end
